...
class HostGame extends javax.swing.JFrame
{
    ...
    //This thread is used to Accept Input from Player Game
       th=new Thread(new Runnable() {
                           ...
                           JOptionPane.showMessageDialog(f,"You Win!\nHost PACKED!"); 
                            ...
                            return;
                         ...
                         else if(x.equals("showingwinner"))
                                {
                                    ...
                                    {
                                        JFrame f=new JFrame();  
                                        // JOptionPane.showMessageDialog(f,"Host \nYou WIN!\n Player has:"+Win[1]+"\n"+Win[2]);
                                        String[] options = {"Exit Game"};
                                        int choice = JOptionPane.showOptionDialog(
                                            f,                          // Parent frame
                                           "Host \nYou WIN!\n Player has:"+Win[1]+"\n"+Win[2],                    // Message to display
                                            "Game Result",              // Title of the dialog
                                            JOptionPane.DEFAULT_OPTION,  // Default option behavior
                                            JOptionPane.INFORMATION_MESSAGE, // Message type
                                            null,                        // No custom icon
                                            options,                     // Button labels (Continue, Exit)
                                            options[0]                  // Default selected button (Continue)
                                        );
                                    ...
                                    else 
                                    {
                                        ...
                                        // Use the result of the dialog to make decisions
                                        if (choice == 0) {
                                            // "Continue to Next Game" clicked
                                            System.out.println("Host Gone"); // Call your function to continue to the next game
                                        } else if (choice == 1) {
                                            // "Exit Game" clicked
                                            System.out.println("Host chose to exit the game.");
                                            setVisible(false); 
                                            return;
                                             // Call your function to exit the game
                                        } else {
                                            // Dialog closed without selecting a button
        ...
        // This thread is used to start the game.
...
class PlayerGame extends javax.swing.JFrame 
{
    ...
    PlayerGame(DataInputStream din,DataOutputStream dout,String[] allcards)
    {
                        ...
                        while(true)
                        {
                            try {
                                ...
                                else if(x.equals("showingwinner"))
                                {
                                    ...
                                    {
                                        JFrame f=new JFrame();  
                                        // JOptionPane.showMessageDialog(f,"Player \nYou LOSE!\nHost has:"+Win[1]+"\n"+Win[2]);
                                        String[] options = {"Exit Game"};
                                        int choice = JOptionPane.showOptionDialog(
                                            f,                          // Parent frame
                                            "Player \nYou LOSE!\nHost has:"+Win[1]+"\n"+Win[2],                    // Message to display
                                        ...
                                        if (choice == 0) {
                                            // "Continue to Next Game" clicked
                                            System.out.println("Player chose to continue to the next game."); // Call your function to continue to the next game
                                        } else if (choice == 1) {
                                            // "Exit Game" clicked
                                            System.out.println("Player chose to exit the game.");
                                            setVisible(false); 
                                            return;
                                             // Call your function to exit the game
                                        } else {
        ...
        // This thread is used to play the game from player
